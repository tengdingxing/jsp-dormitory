...
<div class="page-content">
    ...
    <div class="weadmin-body">
        <div class="layui-row">
            <form class="layui-form layui-col-md12 we-search" method="get" action="/findBedsByName" accept-charset="UTF-8">
                ...
                <div class="layui-inline">
                    <input type="text" name="roomname" placeholder="宿舍号：如5B604" autocomplete="off" class="layui-input" />
                </div>
        ...
        <div class="weadmin-block">
            ...
            <button class="layui-btn" onclick="WeAdminShow('添加学生','/goAddBed',600,400)">
                <i ></i>添加
            </button>
            <span class="fr" style="line-height:40px">共有数据：${fn:length(beds)}  条</span>
        </div>
              ...
              <%--  <td>
                ...
                <td class="td-manage">
                   ...
                   <%-- <a title="新增" onclick="WeAdminEdit('新增','./edit.html', 1, 600, 400)" href="javascript:;">
                    ...
                    <a  title="修改" onclick="WeAdminShow('修改床位状态','/goUpdateBed?id=${bed.id}',600,400)" >
                        <span style="color: #0000FF; font-weight: bolder" >修改</span>
                    </a>&nbsp;&nbsp;&nbsp;&nbsp;
                    <a title="删除" onclick="member_del(this,'要删除的id')" href="/deleteBed/${bed.id}" >
