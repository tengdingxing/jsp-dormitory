...
<body>
  ...
  <div class="weadmin-body">
    <form class="layui-form" action="/addRoom" accept-charset="UTF-8" method="post">
      ...
      <div class="layui-form-item">
        ...
        <div class="layui-input-block">
          <input type="text" name="bedcount" required  lay-verify="required"  autocomplete="off" class="layui-input">
        </div>
      </div>
